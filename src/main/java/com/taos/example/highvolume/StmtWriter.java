...
public class StmtWriter {
    final static Logger logger = LoggerFactory.getLogger(StmtWriter.class);
    ...
    public StmtWriter(int maxBatchSize) {
    ...
    private static Connection getConnection() throws SQLException {
        String jdbcURL = "jdbc:TAOS://192.168.0.66:6030/shangma_sys?user=root&password=taosdata";
    ...
    /**
     * Assemble INSERT statement using buffered SQL fragments in Map {@link StmtWriter#tbValues} and execute it.
    ...
    private void executeSQL(List<String> lineList) throws SQLException {
        try {
            SchemalessWriter writer = new SchemalessWriter(conn);
            writer.write(lineList, SchemalessProtocolType.LINE, SchemalessTimestampType.NANO_SECONDS);
            ...
            Console.log("Execute SQL: {}", CollUtil.join(lineList,"\n"));
            throw e;
